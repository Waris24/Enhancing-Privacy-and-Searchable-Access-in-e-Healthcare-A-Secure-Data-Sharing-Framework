...
<html lang="en">
    <head>
        <title>Enhancing Privacy and Searchable Access in e-Healthcare: A Secure Data Sharing Framework
</title>
        <meta charset="UTF-8">
        ...
        <section class="navbar navbar-default navbar-static-top" role="navigation">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <!-- lOGO TEXT HERE -->
                    <a href="#" class="navbar-brand"><i class="fa fa-stethoscope"></i>&nbsp;EPS-HealthCare</a>
                </div>
          ...
          <div class="container">
               <div class="row">
                   <center><h2>Patients Details</h2></center>
                    <button id="printButton" class="btn btn-primary pull-right">Print</button>
                        <br> <br> <br>
